...
const I18N = {
  bn: {
    ...
    cancelledLeadsTab: "বাতিল হওয়া Lead",
    cancelledLeadBadge: "বাতিল হয়েছে",
    noCancelledLeads: "কোনো বাতিল হওয়া Lead নেই।",
    cancelBtn: "❌ বাতিল",
    cancelLeadConfirm: "এই Lead-টা বাতিল করতে চান?",
    cancelOrderConfirm: "এই Order-টা বাতিল করতে চান?",
    cancelFailed: "বাতিল করা যায়নি।",
    restoreBtn: "↩️ ফিরিয়ে আনুন",
    restoreOrderConfirm: "এই Order-টা আগের অবস্থায় ফিরিয়ে আনতে চান?",
    restoreLeadConfirm: "এই Lead-টা আবার Abandoned Leads-এ ফিরিয়ে আনতে চান?",
    restoreFailed: "ফিরিয়ে আনা যায়নি।",
    cancelReasonPrompt: "কেন বাতিল করছেন? (বাধ্যতামূলক)",
    cancelReasonRequired: "বাতিল করার কারণ লিখতে হবে।",
    cancelReasonLabel: "বাতিলের কারণ",
    confirmNotePrompt: "কনফার্ম করার সময় কোনো নোট রাখতে চান? (ঐচ্ছিক)",
    confirmNoteLabel: "কনফার্ম নোট",
    editBtn: "✏️ এডিট",
    editCancelReasonPrompt: "বাতিলের কারণ এডিট করুন:",
  ...
  en: {
    ...
    cancelledLeadsTab: "Cancelled Leads",
    cancelledLeadBadge: "Cancelled",
    noCancelledLeads: "No cancelled leads found.",
    cancelBtn: "❌ Cancel",
    cancelLeadConfirm: "Cancel this lead?",
    cancelOrderConfirm: "Cancel this order?",
    cancelFailed: "Could not cancel.",
    restoreBtn: "↩️ Restore",
    restoreOrderConfirm: "Restore this order to its previous status?",
    restoreLeadConfirm: "Restore this lead back to Abandoned Leads?",
    restoreFailed: "Could not restore.",
    cancelReasonPrompt: "Why are you cancelling? (required)",
    cancelReasonRequired: "You must provide a reason to cancel.",
    cancelReasonLabel: "Cancel Reason",
    confirmNotePrompt: "Any note to add while confirming? (optional)",
    confirmNoteLabel: "Confirm Note",
    editBtn: "✏️ Edit",
    editCancelReasonPrompt: "Edit cancel reason:",
